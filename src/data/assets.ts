...
export const assets: Asset[] = [
  ...
  /* ------------------------------------------------- Malaysia — Searah Malaysia Borneo */
  {
    id: 'sarawak-sk-310',
    name: 'Kasawari Block',
    entityId: 'SMB',
    ...
    type: 'Offshore',
    status: 'Producing',
    operator: 'Searah Malaysia Borneo',
    workingInterest: 55,
